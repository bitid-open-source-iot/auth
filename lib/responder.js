	...
	var responder = {
		...
		error: (req, res, err) => {
			if (typeof (err) != 'undefined') {
				...
				var err = tools.log('error', 'Error in responder.error', 'Internal server error!', { reqOriginalUrl: req.originalUrl, reqBody: req?.body, reqAuthorization: req?.authorization });
